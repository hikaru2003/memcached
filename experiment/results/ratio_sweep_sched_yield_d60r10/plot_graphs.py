"""
Usage:
    cd experiment/results/ratio_sweep_sched_yield_d60r10
...
PAUSE_VALUES = [0, 10, 40, 100]
X_LABELS = ['master', '0', '10', '40', '100']
...
fig.suptitle(
    'PAUSE effect on memcached  [sched_yield spinlock, -r 1, -t 32, mutilate -T 4 -c 4]\n'
...
for ratio, color in zip(all_data.keys(), RATIO_COLORS):
    ...
    fig.suptitle(
        ...
        'sched_yield spinlock / -r 1 / -t 32 / mutilate -T 4 -c 4',
